...
enum custom_keycodes {
    ...
    MACRO_CPP,
    MACRO_COMMIT,                // Macro commit git
    MACRO_PARENS                 // Macro parentesis
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LAYER1] = LAYOUT( /* Fn_space */
        ...
        _______,          KC_LEFT, KC_DOWN, KC_RIGHT,        KC_HOME,           _______,        _______,    KC_END,  _______, _______, MACRO_PARENS, _______,          _______,
        _______,          CW_TOGG, _______, KC_VOLD,         KC_VOLU,           _______,        RALT(KC_N), _______, KC_MPRV, KC_MPLY, KC_MNXT,       _______,  _______,
    ...
    [_LAYER2] = LAYOUT( /* Capslock Layer (for macros)*/
        ...
        _______,               _______,       MACRO_SPOTIFY, _______, MACRO_FXSOUND, MACRO_COMMIT, _______, _______, _______, _______, _______, _______,                  _______,
